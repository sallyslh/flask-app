...
def index():
    if request.method == 'POST':
        ...
        # Determine the overall sentiment label based on the maximum sum
        sentiment_labels = ['Positive', 'Negative', 'Neutral']
        overall_sentiment_index = [positive, negative, neutral].index(max(positive, negative, neutral))
        overall_sentiment_label = sentiment_labels[overall_sentiment_index]

        return render_template('display.html', df=df, overall_sentiment=overall_sentiment_label)  
